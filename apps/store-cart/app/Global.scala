...
object Global extends GlobalSettings {
  ...
  override def onStart(app: Application): Unit = {
    ...
    Actors.cartView.set(Actors.system().actorOf(Props(classOf[CartView])))
    ...
    Actors.cartService.set(Actors.system().actorOf(Props(classOf[RemoteCartService]), Directory.CART_SERVICE_NAME))
  }
